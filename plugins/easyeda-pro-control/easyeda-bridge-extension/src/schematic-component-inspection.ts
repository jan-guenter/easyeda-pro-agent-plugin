...
export interface SchematicComponentInspectionItem {
  primitiveId: string;
  reference: string;
  value: string;
  footprint: string;
...
export interface SchematicComponentInspectionResult {
  total: number;
  items: SchematicComponentInspectionItem[];
}

export interface SchematicComponentInspectionOperations {
  listComponents(limit?: number, offset?: number): Promise<SchematicComponentInspectionResult>;
}
...
export function createSchematicComponentInspectionOperations({
  ...
  async function mapComponent(
    component: unknown,
    footprintClass: { get(uuid: unknown, libraryUuid: unknown): Promise<unknown> } | undefined,
  ): Promise<SchematicComponentInspectionItem> {
  ...
  async function listComponents(
    limit?: number,
    offset = 0,
  ): Promise<SchematicComponentInspectionResult> {
    ...
    const items: SchematicComponentInspectionItem[] = [];
