...
// Script scope where `eda`/`EDA`/`api` may exist as scope-locals. Centralized
// Runtime lookup keeps those host-specific boundaries explicit and testable.
...
export interface Dispatcher {
  ...
  methodList: string[];
  /** Build identifier injected at bundle time for reviewed-code admission. */
  buildId: string;
}
