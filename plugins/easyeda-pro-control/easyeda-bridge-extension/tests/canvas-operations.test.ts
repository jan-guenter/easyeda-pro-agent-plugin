...
import { createCanvasOperations } from '../src/canvas-operations.js';
import type { CanvasOperationDependencies } from '../src/canvas-operations.js';
...
describe('canvas operations', () => {
  ...
  it('does not capture when EasyEDA rejects the region zoom', async () => {
    ...
    const normalizeBinaryResult = vi.fn(async () => {});
    const operations = makeOperations({ callFirst, normalizeBinaryResult });
